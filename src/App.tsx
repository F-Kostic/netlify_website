  ...
  const [desktopIcons] = useState<DesktopIcon[]>([
    ...
    { 
      ...
      items: [
        ...
        { name: 'Pro Mouse Grip 4', type: 'image', url: 'https://drive.google.com/file/d/1KTl1Rn_Pt4QsGOuoOhP10W1C-oRG1Uo1/view?usp=drive_link' },
        { name: 'Pro Mouse Grip 4', type: 'image', url: 'https://drive.google.com/file/d/19g_Dr7JdVOLmT3sk-N_axYiQUQ2Dz1xt/view?usp=drive_link' },
